...
<div id="myModal" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="false">
  <div class="modal-dialog">
    ...
    <input type="hidden" value="<?php echo  $row['id'];?>" name="user_id" id="id">
    <input type="text" class="form-control" value="<?php echo  $row['first_name'];?>" name="first_name" id="fname">
  </div>
   <div class="form-group">
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" name="address" id="address"><?php echo  $row['addressinfo'];?></textarea>
  </div>
 ...
 while ($row = $instituteresult->fetch_assoc()) {
  ...
  <div class="col-md-3">
    <label for="fname">Institute:</label>
       <input type="hidden" value="<?php echo $row['id'] ?>"  name="institute_ids[]" id="institute_ids">
    <input type="text" class="form-control" value="<?php echo $row['institute'] ?>"  name="institute_name[]" id="institute_name">
  </div>
   <div class="col-md-3">
    <label for="lname">Batch:</label>
    <input type="text" name="batch[]" value="<?php echo $row['batch'] ?>"  class="form-control" id="batch">
  </div>
  <div class="col-md-3">
    <label for="lname">Percentage:</label>
    <input type="text" name="edu_percentage[]" value="<?php echo $row['percentage'] ?>"  class="form-control" id="edu_percentage">
  </div>
   <div class="col-md-3">
    <?php if($i==0){ ?>
    <button type="button"   class="btn btn-danger" id="addinstitutebutton">Add</button>
    <?php } ?>
     <a href="removeReport.php?ins_id=<?php echo $row['id'];?>.&&user_id=<?php echo $row['user_id'];?>" class="btn btn-primary removeReportRow">X</a>
  </div>
</div>
<?php $i++ ; } ?>
...
<script type="text/javascript">
    ...
    $('.addReportButton').click(function(){
       var html='';
       html +='<div class="row">';
  html +='<div class="col-md-3"><label for="fname">Exam Name:</label><input type="text" class="form-control"  name="newexam_name[]" id="exam_name"></div>';
  html +='<div class="col-md-3"> <label for="lname">Marks:</label><input type="text" name="newmarks[]"  class="form-control" id="marks"></div>';
  html +='<div class="col-md-3"><label for="lname">Percentage:</label><input type="text" name="newpercentage[]"  class="form-control" id="percentage"> </div>';
html +='<div class="col-md-3"><button type="button" class="btn btn-danger remove_row" >X</button></div></div>';
// alert(html);
$('.appendreport').append(html);
    ...
    $('#addinstitutebutton').click(function(){
       var html='';
       html +='<div class="row">';
  html +='<div class="col-md-3"><label for="fname">Institute:</label><input type="text" class="form-control"  name="new_institute_name[]" id="new_institute_name"></div>';
  html +='<div class="col-md-3"> <label for="lname">Batch:</label><input type="text" name="new_batch[]"  class="form-control" id="marks"></div>';
  html +='<div class="col-md-3"><label for="lname">Percentage:</label><input type="text" name="new_edu_percentage[]"  class="form-control" id="percentage"> </div>';

...
<div class="container">
    ...
    <div class="form-inline">
        ...
        <button type="button" class="btn btn-info btn-md" data-toggle="modal" data-target="#myModal">Assign Subjects To Class</button>
    </div> 
    </form>
            ...
            <div class="modal-body">
                <form method="post">
                    ...
                    <?php while ($row = $classresultmodel->fetch_assoc()) { 
                        ...
                        ?>
                        <option value="<?= $row['id'];?>"<?= $selected;?>><?php echo $row['class_name'];?></option>
                        <?php } ?>
                    </select>
                    </div>
                    <div class="col-md-6">

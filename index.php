...
<body>
	...
	<script type="text/javascript">
		$('#addinstitutebutton').click(function() {
			...
			html += '<div class="row">';
			html +=
				'<div class="col-md-3"><label for="fname">Institute:</label><input type="text" class="form-control"  name="institute_name[]" id="exam_name"></div>';
			html +=
				'<div class="col-md-3"> <label for="lname">Batch:</label><input type="text" name="batch[]"  class="form-control" id="marks"></div>';
			html +=
				'<div class="col-md-3"><label for="lname">Percentage:</label><input type="text" name="percentage[]"  class="form-control" id="percentage"> </div>';
			html +=
